  ...
  return (
    <div className="main">
      <div className="mainDiv">
        ...
        <ul>
          <li>
            They are triggered at different moments in the component.When state
            change when props change, when the component mounts, when the
            component unmounts.
          </li>
          <li>
            Effects are used to trigger certain actions based upon what change
            occurred.
          </li>
          <li>
            Effects can return cleanup functions, which can clean up timers
            using memory, subscriptions listening for changes from external
            sources, and other functions which may use system resources.
          </li>
        </ul>
        <SampleEffect />
        <br />
